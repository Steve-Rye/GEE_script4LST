/*
 * Landsat 5 Level 2, Collection 2, Tier 1数据集波段说明
 * 
 * 地表温度相关波段：
 * ST_B6 - 热红外波段温度
 *   - 比例因子: 0.00341802
 *   - 偏移量: 149.0
 *   注：TM的Band6热红外波段与ETM+6和TIRS Band10热红外波段具有近似的波谱范围
 * 
 * 大气参数相关波段：
...
// 设置时间范围
var startDate = '2008-09-01';
var endDate = '2008-10-01';
...
var calculateLST = function(image) {
  ...
  // 使用普朗克公式计算地表温度LST2
  var LST2 = ee.Image(1260.56).divide(
    ee.Image(607.76).divide(blackbodyRadiation).add(1).log()
  ).subtract(273.15);
